...
-- --------------------------------------------------
-- Date Created: 08/22/2017 02:22:07
-- Generated from EDMX file: D:\Programacao\C#\Werewolf\Werewolf for Telegram\Database\WerewolfModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[ImageLanguages]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ImageLanguages];
GO
...
-- Creating table 'ImageLanguages'
CREATE TABLE [dbo].[ImageLanguages] (
    [Id] int IDENTITY(1,1) NOT NULL,
    [LanguageVariant] nvarchar(max)  NOT NULL,
...
-- Creating primary key on [Id] in table 'ImageLanguages'
ALTER TABLE [dbo].[ImageLanguages]
ADD CONSTRAINT [PK_ImageLanguages]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
