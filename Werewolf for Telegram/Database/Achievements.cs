...
namespace Database
{
    ...
    public enum Achievements : long
    {
        ...
        HereJohnny = 8192,
        [Display(Name="Eu te dou cobertura"), Description("Salve 50 pessoas como o the Arcanjo")]
        GotYourBack = 16384,
        ...
        DoubleKill = 67108864,
        [Display(Name= "Eu deveria saber"), Description("Como telepata, revele o Vigia")]
        ...
        [Display(Name="Hail Hydra!"), Description("Seja um dos 10 agentes da Hyrda sobreviventes no final da partida")]
